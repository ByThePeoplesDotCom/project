...
$parse = file_get_contents('/var/www/html/json/WA/l_bills.tsv');
$delimiter = "\n";
...
foreach ( $splitcontents as $line )
{
    ...
    file_put_contents('/var/www/html/json/WA/f_l_bills.tsv', "\n $id \t $bits[1] \t $title \t $f_subs \t $bill_id", FILE_APPEND);
    
    }
    $filename = '/var/www/html/json/WA/f_l_bills.tsv';
